...
async def start(event):
    ...
    collection.update_one({"user_id": user_id}, {"$set": {"user_id": user_id}}, upsert=True)
    buttons = [
        [Button.url("Join Channel", url="https://t.me/SSC_HSSC_FREE_BATCHES")],
...
S = "/start"
START_PIC = "https://telegra.ph/Rizz-07-16-2"
...
async def term_command(event):
    ...
    buttons = [
        [Button.url("Query?", url="https://t.me/RD_C4"),
         Button.url("Channel", url="https://t.me/SSC_HSSC_FREE_BATCHES")]
    ]
...
REPO_URL = "https://telegra.ph/Rizz-07-16-2"
...
async def youtube_dl_command(_, message):
    ...
    if len(message.command) > 1:
        ...
        try:
            ...
            caption = f"{video_info['title']}\n\n__**Powered by [Advance Content Saver Bot](https://t.me/Restricted_saber_bot)**__"  # Set caption to the title of the video
